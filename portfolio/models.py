...
class Info(models.Model):
    profile_pic = models.ImageField("Profile picture", upload_to='portfolio/static/images/', height_field=None, width_field=None, max_length=None)
    ...
    resume = models.FileField("resume", upload_to='portfolio/static/images/', max_length=100)
...
class Work(models.Model):
    project_image = models.ImageField('Project image', upload_to='portfolio/static/images/', height_field=None, width_field=None, max_length=None)
